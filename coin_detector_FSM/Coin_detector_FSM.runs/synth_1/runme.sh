...
HD_PWD='C:/Users/Vihan/coin_detector_FSM/Coin_detector_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coin_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coin_FSM.tcl
