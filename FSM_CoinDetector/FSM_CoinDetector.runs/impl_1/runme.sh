...
HD_PWD='C:/Users/Vihan/FSM_CoinDetector/FSM_CoinDetector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_OneHot.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_OneHot.tcl -notrace
