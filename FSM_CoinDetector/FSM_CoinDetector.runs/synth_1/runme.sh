...
HD_PWD='C:/Users/Vihan/FSM_CoinDetector/FSM_CoinDetector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_OneHot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_OneHot.tcl
